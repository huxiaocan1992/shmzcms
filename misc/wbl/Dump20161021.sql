...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COMMENT='内容表，用于存放比如文章、帖子、商品、问答等用户自定义模型内容。也用来存放比如菜单、购物车、消费记录等系统模型。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `jpress_mapping` (
  ...
  KEY `content_id` (`content_id`)
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8mb4 COMMENT='内容和分类的多对多映射关系。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jpress_mapping` VALUES (4,2,10),(5,2,11),(6,3,17),(7,3,19),(12,4,1),(13,4,8),(16,1,1),(17,1,9),(18,10,1),(19,10,2),(20,11,1),(21,11,9),(22,12,10),(23,12,12),(24,13,10),(25,13,13),(26,14,10),(27,14,14),(28,15,10),(29,15,15),(30,16,10),(31,16,16),(34,17,10),(35,17,11),(36,18,10),(37,18,11),(38,19,10),(39,19,11),(44,22,1),(45,22,9),(46,23,1),(47,23,9),(48,24,1),(49,24,9),(50,25,1),(51,25,9),(52,26,1),(53,26,9),(54,27,1),(55,27,9),(56,28,1),(57,28,9),(60,32,17),(61,32,19),(64,21,10),(65,21,11),(66,20,10),(67,20,11);
...
CREATE TABLE `jpress_metadata` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COMMENT='元数据表，用来对其他表的字段扩充。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jpress_user` VALUES (1,'admin',NULL,NULL,'d6f92ec98e6799f36b1aa118402017e04e12d46b4d239c628717f28b6aaa7b0a','4298b0e6d3b326cc427c',NULL,NULL,NULL,NULL,NULL,0.00,NULL,'administrator',NULL,24,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'activited','2016-10-20 11:21:45',NULL,'2016-10-21 17:29:00',NULL);
...
-- Dump completed on 2016-10-21 22:29:15
